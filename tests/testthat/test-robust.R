test_that("robust_calculation works as expected", {
  ...
  expected_summary <- data.table(
    ...
    lb = c(-0.00109058785698629, 3.27378157862297e-06, -6.10911458821171e-06, -0.00329101230781582),
    ub = c(0.0038164889550598, 2.44924377024549e-05, 1.94465776879711e-05, 0.00221602491864713),
    z = c(1.08878796009642, 2.56480850970521, 1.02291995822361, -0.382596883973469),
    p_value = c("0.276247", "0.010323", "0.306346", "0.702019")
  )

  expect_identical(result$summary, expected_summary, tolerance = 1e-10)

  expected_matrix <- matrix(
    c(1.56701653212986e-06, -6.16533629055698e-09, -5.36729872715042e-09,
