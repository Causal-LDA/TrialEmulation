...
#>  
#>  path                                                          
#>  /tmp/Rtmp4ddJUA/trial_itt/switch_models/model_1f1e2bc48a51.rds
#>  
#> [[d0]]
...
#>  
#>  path                                                          
#>  /tmp/Rtmp4ddJUA/trial_itt/switch_models/model_1f1e4480a916.rds
#>  
#> [[d1]]
...
#>  
#>  path                                                          
#>  /tmp/Rtmp4ddJUA/trial_itt/switch_models/model_1f1e7cadd8e9.rds
#> 
```
