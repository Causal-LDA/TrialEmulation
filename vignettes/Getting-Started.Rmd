...
str(sampled_data)
```
You should confirm the data has the correct format, including factor levels here.
You could also manipulate and derive new variables before proceeding with the modelling.
