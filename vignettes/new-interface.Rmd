...
```{r}
trial_itt <- sample_controls(trial_itt, seed = 1234, p_control = 1)
...
plot(preds$difference$followup_time, preds$difference$survival_diff, type = "l", xlab = "Follow up", ylab = "Survival difference")
