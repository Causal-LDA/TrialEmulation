...
ways of storing the expanded data: as CSV files and in a DuckDB database. New components can quickly and easily be specified for use with this package, such as alternative model fitting procedures.
...
Users can specify which type of confidence interval construction method they wish to use with the `conf_type` argument. 
The default method is using the robust sandwich variance estimator.
