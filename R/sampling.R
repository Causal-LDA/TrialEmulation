...
#' @param sort Sort data before applying case-control sampling to make sure that the resulting data 
#' are identical when sampling from the expanded data created with `separate_files = TRUE` or `separate_files = FALSE`.
#'
